...
function canvasApp ()
{
    ...
    function DoVirusProgression (ball1, ball2)
    {
        ...
        //                                dead
        //
	if ( (ball1.state == DISEASE_STATE_SUSCEPTABLE && ball2.state == DISEASE_STATE_INFECTED) ||
	     (ball2.state == DISEASE_STATE_SUSCEPTABLE && ball1.state == DISEASE_STATE_INFECTED) )
        {
